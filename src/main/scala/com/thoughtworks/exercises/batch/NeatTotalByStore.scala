...
//      .master("local")
    ...
    totalsFormatted.foreach(x => log.info(s"O total de vendas da loja ${x._1} foi ${x._2}"))
    totalsFormatted.foreach(x => println(s"O total de vendas da loja ${x._1} foi ${x._2}"))
