...
object StructuredStreamingExample {
  def main(args: Array[String]): Unit = {
    ...
    FileUtils.deleteQuietly(new File("../data/output/com.thoughtworks.streaming"))
    FileUtils.deleteQuietly(new File("../data/output/parquet/com.thoughtworks.streaming"))
    ...
    val wordReverseQuery =
      wordReverseDF
        ...
        //.format("console")
        .option("checkpointLocation", "../data/output/com.thoughtworks.streaming/checkpoint")
        .option("path", "../data/output/parquet/com.thoughtworks.streaming")
